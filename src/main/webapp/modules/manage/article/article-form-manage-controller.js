app.controller("ArticleFormManageController", ["$scope", "$location","$uibModal", "$routeParams", "ArticleManageService","CategoryManageService",function ($scope, $location,$uibModal, $routeParams, ArticleManageService,CategoryManageService) {
    var articleEditor;
