app.controller("CategoryManageController", ["$location", "$uibModal", "$scope",
    "CategoryManageService", function ($location, $uibModal, $scope,
        ...
        $scope.addCategory = function () {
            ...
            var modalInstance = $uibModal.open({
                templateUrl: 'modules/manage/category/category-add-view.html',
...
app.controller("editCategoryArticleCtrl", ["$uibModalInstance", "$scope",
    "categoryArticles", "category", function ($uibModalInstance, $scope,
...
app.controller("editCategoryCtrl", ["$uibModalInstance", "CategoryManageService", "$scope", "category", function ($uibModalInstance, CategoryManageService, $scope, category) {
...
app.controller("deleteCategoryCtrl", ["$scope", "$uibModalInstance", "category", "CategoryManageService", function ($scope, $uibModalInstance, category, CategoryManageService) {
    $scope.category = category;
